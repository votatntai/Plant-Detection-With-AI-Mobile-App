...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    primaryColor: miaPrimaryColor,
    primaryColorDark: miaPrimaryColor,
    ...
    textTheme: TextTheme(
      labelLarge: TextStyle(color: miaPrimaryColor),
      titleLarge: TextStyle(color: textPrimaryColor),
      titleSmall: TextStyle(color: textSecondaryColor),
    ),
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.light(primary: miaPrimaryColor).copyWith(error: Colors.red),
  ).copyWith(
