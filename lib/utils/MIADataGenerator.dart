...
List<MIADashboardModel> getFragmentsList() {
  ...
  list.add(MIADashboardModel(image: 'images/game.png', tab: 'Game'));
...
List<MIAMealModel> getMealList() {
  ...
  list.add(MIAMealModel(image: 'images/plate_one.jpg', text: 'Brussels Sprouts, Mashed Potatoes & Sausage Bowl with sugar', added: false, pro: true));
  list.add(MIAMealModel(image: 'images/plate_two.jpg', text: 'Roasted Cauliflower & Black Bean Burrito Bowl with Cilantro Lights', added: false, pro: false));
  list.add(MIAMealModel(image: 'images/plate_three.jpg', text: 'Creamy Cashew Zucchini Noodles with Vegan Sausage, Article', added: false, pro: false));
  list.add(MIAMealModel(image: 'images/plate_four.jpg', text: 'Lebanese Lentils, Rice & fried Onions (Mujadara) with Chocolate', added: false, pro: true));
  list.add(MIAMealModel(image: 'images/plate_five.jpg', text: 'Brussels Sprouts, Mashed Potatoes & Sausage Bowl with sugar', added: false, pro: false));
...
List<MIASelectOptionsModel> getShopsList() {
  ...
  list.add(MIASelectOptionsModel(title: 'Asda', subtitle: 'images/asda.png', selected: false));
  list.add(MIASelectOptionsModel(title: 'Ocado', subtitle: 'images/ocado.png', selected: false));
  list.add(MIASelectOptionsModel(title: 'Tesco', subtitle: 'images/tesco.png', selected: false));
...
List<MIADashboardModel> getSettingsList() {
  ...
  list.add(MIADashboardModel(image: 'images/adjust.png', tab: 'Eating Preferences'));
