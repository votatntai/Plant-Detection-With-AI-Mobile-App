...
import 'package:mealime_app/screens/MIAInstructionStepScreen.dart';
            ...
            Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(top: 30, child: Image.asset('images/hand.png', color: Colors.grey.shade600, height: 350, fit: BoxFit.cover)),
                  Positioned(
                    bottom: 20,
                    child: AppButton(
                      width: context.width() - 32,
