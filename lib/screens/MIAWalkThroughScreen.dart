...
class _WalkThroughModelScreenState extends State<WalkThroughModelScreen> {
  ...
  void init() {
    walkThroughList.add(WalkThroughModelClass(
        ...
        image: 'images/walkthrough_one.png'));
    walkThroughList.add(WalkThroughModelClass(
        title: 'Simple, stress-free grocery shopping', subTitle: 'Grocery shop once per week with an organized "done for you" shopping list.', image: 'images/walkthrough_two.png'));
    walkThroughList.add(WalkThroughModelClass(
        title: 'Delicious healthy meals made easy', subTitle: 'Easily cook healthy, delicious meals in about 30 minutes, from start to finish.', image: 'images/walkthrough_three.png'));
  }
